...
public class AlmacenTabFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_almacen_tab_fragment4, container, false);
        almacenList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.rvAlmacen4);
